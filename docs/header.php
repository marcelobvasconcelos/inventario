    ...
    <header class="main-header">
        ...
        <div class="user-menu">
            ...
            <div class="user-menu-dropdown">
                <button class="user-menu-button">Ajuda <i class="fas fa-caret-down"></i></button>
                <div class="user-menu-content">
                    <a href="/inventario/docs.php">Manual Geral</a>
                    <a href="/inventario/docs.php?page=ALMOXARIFADO">Almoxarifado</a>
                    <a href="/inventario/docs.php?page=ALMOXARIFADO_FINANCEIRO">Financeiro (Almox.)</a>
                    <a href="/inventario/docs.php?page=EMPENHOS">Empenhos</a>
                </div>
            </div>
